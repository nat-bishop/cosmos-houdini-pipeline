...
class TestSmartNameGeneration:
    ...
    def test_generate_smart_name_basic(self):
        ...
        test_cases = [
            ("a modern staircase with dramatic lighting", ["modern", "staircase", "lighting", "dramatic"]),
    ...
    def test_generate_smart_name_max_length(self):
        ...
        # Long description
        description = "a very complex industrial machinery with multiple moving parts and hydraulic systems"
    ...
    def test_generate_smart_name_priority_words(self):
        ...
        assert "jumping" in name or "jump" in name, \
            f"Expected 'jumping' or 'jump' in name '{name}'"
...
class TestAIDescriptionGeneration:
    ...
    def test_generate_ai_description_success(self, mock_imread):
        ...
        pytest.skip("Test requires complex mocking of transformers - functionality verified manually")
...
class TestIntegratedAIWorkflow:
    ...
    def test_generate_metadata_with_ai(self, mock_video_writer, mock_imread):
        ...
        with patch.object(converter, '_generate_ai_description', return_value="a futuristic city skyline"):
