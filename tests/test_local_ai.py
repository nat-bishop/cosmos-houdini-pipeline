...
class TestVideoProcessor:
    ...
    def create_test_png_sequence(self, num_frames: int = 10, width: int = 640, height: int = 480,
                                has_gap: bool = False, pattern: str = "frame_{:03d}.png") -> Path:
