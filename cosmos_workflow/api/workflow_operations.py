...
class WorkflowOperations:
    ...
    def quick_inference(
        ...
        **kwargs,
        ...
        """Quick inference from existing prompt - creates run and executes immediately.
        ...
        # Execute immediately
        result = self.execute_run(run["id"])
    ...
    def batch_inference(
        ...
        **kwargs,
        ...
        Args:
            ...
            shared_weights: Weights to use for all prompts
            **kwargs: Additional execution parameters
        ...
        for prompt_id in prompt_ids:
            ...
            run = self.create_run(prompt_id, weights=shared_weights, **kwargs)
