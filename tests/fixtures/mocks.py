...
class MockDockerExecutor:
    ...
    def run_inference(self, spec_path: str, num_gpus: int = 1, 
...
class MockVideoProcessor:
    ...
    def standardize_video(self, input_path: str, output_path: str, 
                         target_fps: int = None, target_resolution: str = None) -> bool:
        """Mock video standardization."""
        return self.valid
    
    def extract_frame(self, video_path: str, frame_number: int, 
                     output_path: str = None) -> Optional[Any]:
...
class MockRunSpecManager:
    ...
    def create_run_spec(self, prompt_spec_id: str, **kwargs) -> Tuple[str, Mock]:
        ...
        spec.parameters = kwargs.get('parameters', {
            'num_steps': 35,
            'guidance_scale': 8.0,
            'seed': 42
        })
