...
class TestPromptManagerOrchestrator:
    ...
    def test_create_prompt_spec_delegates_to_manager(self):
        ...
        with patch('cosmos_workflow.prompts.prompt_manager.ConfigManager') as mock_config_class:
            ...
            with patch.object(prompt_manager.prompt_spec_manager, 'create_prompt_spec') as mock_create:
    ...
    def test_get_prompt_info_delegates_to_manager(self):
        ...
        with patch('cosmos_workflow.prompts.prompt_manager.ConfigManager') as mock_config_class:
            ...
            with patch.object(prompt_manager.prompt_spec_manager, 'get_prompt_info') as mock_get_info:
    ...
    def test_prompt_manager_method_chaining(self):
        ...
        with patch('cosmos_workflow.prompts.prompt_manager.ConfigManager') as mock_config_class:
            ...
            with patch.object(prompt_manager.prompt_spec_manager, 'create_prompt_spec') as mock_create_prompt:
                with patch.object(prompt_manager.run_spec_manager, 'create_run_spec') as mock_create_run:
