...
class TestPromptSystemIntegration:
    ...
    def test_complete_workflow_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            assert (
                prompt_spec.prompt == "A futuristic cyberpunk city with neon lights and flying cars"
            )
    ...
    def test_validation_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            prompt_spec = prompt_manager.create_prompt_spec(
                "validation_test", "Test prompt for validation"
            )
    ...
    def test_error_handling_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            prompt_spec = prompt_manager.create_prompt_spec(
                "error_test", "Test prompt for error handling"
            )

            with pytest.raises(ValueError):
                # This should fail due to invalid parameters
                prompt_manager.create_run_spec(
                    prompt_spec=prompt_spec, parameters={"invalid": "parameter"}
                )
    ...
    def test_serialization_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            # Create specifications
            prompt_spec = prompt_manager.create_prompt_spec(
                "serialization_test", "Test prompt for serialization"
            )
    ...
    def test_manager_coordination_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            prompt_spec = prompt_manager.prompt_spec_manager.create_prompt_spec(
                "independent_test", "Test independent manager usage"
            )

            run_spec = prompt_manager.run_spec_manager.create_run_spec(
                prompt_id=prompt_spec.id, name=prompt_spec.name
            )
    ...
    def test_edge_cases_integration(self):
        ...
        with patch("cosmos_workflow.prompts.prompt_manager.ConfigManager") as mock_config_class:
            ...
            long_prompt = "A" * 1000
            prompt_spec = prompt_manager.create_prompt_spec("long_text_test", long_prompt)

            # Test with special characters
            special_prompt = "!@#$%^&*()_+-=[]{}|;':\",./<>?"
            prompt_spec2 = prompt_manager.create_prompt_spec("special_chars_test", special_prompt)

            # Test with unicode
            unicode_prompt = "Test with émojis🚀 and 字符"
            prompt_spec3 = prompt_manager.create_prompt_spec("unicode_test", unicode_prompt)
