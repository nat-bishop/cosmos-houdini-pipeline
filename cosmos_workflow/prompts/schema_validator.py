...
class SchemaValidator:
    ...
    def validate_prompt_spec(prompt_path: Union[str, Path]) -> bool:
        ...
        try:
            ...
            required_fields = ["id", "name", "prompt", "negative_prompt", "input_video_path", "timestamp"]
            ...
            if not prompt_data["id"].startswith("ps_"):
                print(f"❌ Invalid ID format: {prompt_data['id']}")
                return False
            
            print(f"✅ PromptSpec validation passed")
            return True
    ...
    def validate_run_spec(run_path: Union[str, Path]) -> bool:
        ...
        try:
            ...
            # Check required fields
            required_fields = ["id", "prompt_id", "name", "control_weights", "parameters", "timestamp", "execution_status"]
            for field in required_fields:
