...
class DockerExecutor:
    ...
    def get_docker_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            docker_info = self.ssh_manager.execute_command_success("sudo docker info", stream_output=False)
            
            # Check available images
            images_output = self.ssh_manager.execute_command_success("sudo docker images", stream_output=False)
            
            # Check running containers
            containers_output = self.ssh_manager.execute_command_success("sudo docker ps", stream_output=False)
    ...
    def cleanup_containers(self) -> None:
        ...
        try:
            self.ssh_manager.execute_command_success("sudo docker container prune -f", stream_output=False)
    ...
    def get_container_logs(self, container_id: str) -> str:
        ...
        try:
            return self.ssh_manager.execute_command_success(f"sudo docker logs {container_id}", stream_output=False)
        except Exception as e:
