...
def main():
    ...
    parser.add_argument("--prompt", type=str, required=True, help="Prompt to upsample")
    ...
    parser.add_argument(
        "--output-file",
        type=str,
        default="/workspace/outputs/upsampled.json",
    ...
    try:
        ...
        upsampler = PixtralPromptUpsampler(
            checkpoint_dir=args.checkpoint_dir, offload_prompt_upsampler=True
        )
