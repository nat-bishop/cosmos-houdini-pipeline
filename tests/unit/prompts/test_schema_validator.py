...
class TestSchemaValidator:
    ...
    def test_validate_run_spec_valid(self):
        ...
        with patch('cosmos_workflow.prompts.schema_validator.SchemaUtils') as mock_schema_utils:
            ...
            run_data = {
                ...
                "parameters": {"num_steps": 35, "guidance": 7, "sigma_max": 70, "blur_strength": "medium", "canny_threshold": "medium", "fps": 24, "seed": 1},
                "timestamp": "2025-08-29T10:00:00Z",
    ...
    def test_validate_run_spec_calls_schema_utils(self):
        ...
        with patch('cosmos_workflow.prompts.schema_validator.SchemaUtils') as mock_schema_utils:
            ...
            mock_schema_utils.validate_control_weights.assert_called_once_with(run_data["control_weights"])
    ...
    def test_validate_parameters_valid(self):
        ...
        with patch('cosmos_workflow.prompts.schema_validator.SchemaUtils') as mock_schema_utils:
            ...
            params = {"num_steps": 35, "guidance": 7, "sigma_max": 70, "blur_strength": "medium", "canny_threshold": "medium", "fps": 24, "seed": 1}
