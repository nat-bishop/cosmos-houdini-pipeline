...
class TestFileTransferService:
    ...
    def test_upload_prompt_and_videos_uploads_prompt_file(self):
        ...
        with patch.object(self.file_transfer, '_sftp_upload_file') as mock_sftp_upload_file:
            with patch.object(self.file_transfer, '_sftp_upload_dir') as mock_sftp_upload_dir:
                ...
                mock_sftp_upload_file.assert_any_call(prompt_file, f"{self.remote_dir}/inputs/prompts/test_prompt.json")
    ...
    def test_upload_prompt_and_videos_uploads_video_directories(self):
        ...
        with patch.object(self.file_transfer, '_sftp_upload_file') as mock_sftp_upload_file:
            with patch.object(self.file_transfer, '_sftp_upload_dir') as mock_sftp_upload_dir:
                ...
                mock_sftp_upload_dir.assert_any_call(video_dir, f"{self.remote_dir}/inputs/videos/test_videos")
        ...
        with patch.object(self.file_transfer, '_sftp_upload_file') as mock_sftp_upload_file:
            with patch.object(self.file_transfer, '_sftp_upload_dir') as mock_sftp_upload_dir:
                ...
                with patch('cosmos_workflow.transfer.file_transfer.Path') as mock_path:
                    ...
                    mock_sftp_upload_dir.assert_any_call(scripts_dir, f"{self.remote_dir}/bashscripts")
        ...
        with patch.object(self.file_transfer, '_sftp_upload_file') as mock_sftp_upload_file:
            with patch.object(self.file_transfer, '_sftp_upload_dir') as mock_sftp_upload_dir:
                ...
                with patch('cosmos_workflow.transfer.file_transfer.Path') as mock_path:
                    ...
                    script_uploads = [call for call in mock_sftp_upload_dir.call_args_list 
    ...
    def test_upload_file_uses_sftp_for_single_files(self):
        ...
        with patch.object(self.file_transfer, '_sftp_upload_file') as mock_sftp_upload_file:
            ...
            mock_sftp_upload_file.assert_called_once_with(self.test_file, f"{self.remote_dir}/test/test_file.txt")
    ...
    def test_sftp_upload_file_uses_ssh_manager(self):
        ...
        with patch.object(self.mock_ssh_manager, 'get_sftp') as mock_get_sftp:
            ...
            # Upload file
            self.file_transfer._sftp_upload_file(self.test_file, f"{self.remote_dir}/test/test_file.txt")
            
            # Check that SFTP put was called
            mock_sftp.put.assert_called_once_with(str(self.test_file), f"{self.remote_dir}/test/test_file.txt")
    ...
    def test_sftp_download_dir_handles_recursive_download(self):
        ...
        with patch.object(self.mock_ssh_manager, 'get_sftp') as mock_get_sftp:
            ...
            mock_sftp.get.assert_called_once_with(f"{self.remote_dir}/test_dir/test_file.txt", str(self.test_dir / "test_file.txt"))
