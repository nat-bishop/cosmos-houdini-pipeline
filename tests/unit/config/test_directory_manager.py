...
class TestDirectoryManager:
    ...
    def test_get_prompt_file_path(self):
        ...
        expected_path = self.prompts_dir / "2025-08-29" / "test_prompt_2025-08-29T10-30-45_ps_abc123.json"
    ...
    def test_get_run_file_path(self):
        ...
        expected_path = self.runs_dir / "2025-08-29" / "test_prompt_2025-08-29T10-30-45_rs_def456.json"
        assert file_path == expected_path
    ...
    def test_get_file_paths_with_datetime_objects(self):
        ...
        expected_prompt_path = self.prompts_dir / "2025-08-29" / "test_prompt_2025-08-29T10-30-45_ps_abc123.json"
        expected_run_path = self.runs_dir / "2025-08-29" / "test_prompt_2025-08-29T10-30-45_rs_def456.json"
