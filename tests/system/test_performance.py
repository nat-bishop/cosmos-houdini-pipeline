...
class TestPerformanceBenchmarks:
    ...
    def test_prompt_spec_creation_performance(self, performance_tracker, temp_dir):
        ...
        assert all(m['per_spec_ms'] < 10 for m in performance_tracker.metrics['prompt_spec_creation'])
    ...
    def test_workflow_orchestration_performance(self, performance_tracker):
        ...
        with patch('cosmos_workflow.workflows.workflow_orchestrator.SSHManager') as mock_ssh, \
             patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferManager') as mock_ft, \
             patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor') as mock_docker:
            ...
            for size in workflow_sizes:
                ...
                for i in range(size):
                    ...
                    orchestrator.file_transfer.upload_file(f"file_{i}.json", f"/remote/file_{i}.json")
