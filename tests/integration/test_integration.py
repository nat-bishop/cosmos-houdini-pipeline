...
class TestSystemIntegration:
    ...
    def setup_method(self):
        ...
        self.test_prompt_file.write_text(json.dumps({
...
""")
    ...
    def test_complete_workflow_integration(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
        ...
        mock_ssh_options = {"host": "192.168.1.100", "user": "ubuntu", "key_file": "~/.ssh/test.pem"}
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_workflow_with_custom_video_directory(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_workflow_failure_recovery_and_logging(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
        ...
        mock_file_transfer = Mock()
        mock_file_transfer.upload_prompt_and_videos.side_effect = RuntimeError("Network connection failed")
        mock_file_transfer_class.return_value = mock_file_transfer
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_inference_only_workflow_integration(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_upscaling_only_workflow_integration(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_system_status_check_integration(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
    ...
    @patch('cosmos_workflow.workflows.workflow_orchestrator.FileTransferService')
    @patch('cosmos_workflow.workflows.workflow_orchestrator.DockerExecutor')
    def test_workflow_with_no_upscale_flag(self, mock_docker_class, mock_file_transfer_class, mock_ssh_class):
