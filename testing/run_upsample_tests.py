        ...
        for res in test_resolutions:
            ...
            if specs:
                ...
                if not result["success"]:
                    ...
                    if result["success"]:
                        self.log(f"  ✓ Success with preprocessing")
    ...
    def test_batch_sizes(self, prompt_dir: str):
        ...
        for batch_size in batch_sizes:
            ...
            if result["success"]:
                ...
                self.log(f"  ✓ Batch {batch_size}: {result['duration']:.2f}s total, {time_per_prompt:.2f}s per prompt")
            else:
...
def main():
    ...
    if prompt_manifest_path.exists():
        ...
        if "480p" in specs_by_res and specs_by_res["480p"]:
            tester.test_single_prompt(specs_by_res["480p"][0], "single_480p")
        elif "text_only" in specs_by_res and specs_by_res["text_only"]:
