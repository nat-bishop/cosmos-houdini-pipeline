...
class CosmosConverter:
    ...
    @staticmethod
    def save_cosmos_spec(
        cosmos_spec: Dict[str, Any],
    ...
    @staticmethod
    def create_upscaler_spec(
        input_video_path: str,
        upscale_weight: float = 0.7
    ) -> Dict[str, Any]:
        """
...
def main():
    ...
    parser.add_argument("--output", help="Output path for Cosmos spec", 
                       default="cosmos_spec.json")
    parser.add_argument("--validate", action="store_true", 
                       help="Validate the output spec")
