...
class TestConvertSequenceCommand:
    ...
    def test_convert_sequence_success(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_with_metadata(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_with_resolution(self, mock_video_processor, mock_metadata_extractor, temp_png_dir):
    ...
    def test_convert_sequence_validation_failure(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_video_creation_failure(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_custom_output_path(self, mock_video_processor, mock_metadata_extractor, temp_png_dir):
    ...
    def test_convert_sequence_invalid_resolution_format(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_standardization_failure(self, mock_video_processor, mock_metadata_extractor, temp_png_dir, capsys):
    ...
    def test_convert_sequence_exception_handling(self, mock_video_processor, mock_metadata_extractor, capsys):
...
class TestCLIIntegration:
    ...
    def test_cli_convert_sequence_parsing(self):
        ...
        test_args = [
            'cli.py', 'convert-sequence', './input_dir',
            '--output', './output.mp4',
            '--fps', '30',
            '--resolution', '1080p',
            '--generate-metadata',
