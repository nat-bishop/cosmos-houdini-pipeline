...
class TestDirectoryManager:
    ...
    def test_get_file_paths(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_prompt_path = temp_path / "prompts" / "2024-04-30" / "test_prompt_2024-04-30T12-00-00_ps_test123.json"
            assert prompt_path == expected_prompt_path
            
            # Test run file path
            run_path = dir_manager.get_run_file_path("test_prompt", timestamp, "rs_test123")
            expected_run_path = temp_path / "runs" / "2024-04-30" / "test_prompt_2024-04-30T12-00-00_rs_test123.json"
